...
| Residual / convergence diagnostic plots | **in use** — twelve plots committed under `docs/figures/` (polysvp, qsat, makoh, kohler, wateruptake, calcsize, rename, gasaerexch, soaexch, newnuc_helpers, mer07_veh02 residuals + the upstream flowchart). New ports add their plot per the validation workflow in `CLAUDE.md`. |
